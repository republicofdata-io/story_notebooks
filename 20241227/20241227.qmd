...
Articles are the foundation of platform. We then sniff social networks for any conversations that refer to them. We then capture those conversations as they have a high likelyhood of expression opinions around climate change.
...
result = show_asset('social_networks/x_conversations', configs_dir="../.damn/")
data = json.loads(result)
...
result = asset_metrics('social_networks/x_conversations', configs_dir="../.damn/")
data = json.loads(result)
